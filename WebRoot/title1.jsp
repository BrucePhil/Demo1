			...
			<div class="row">
				...
				<%
					    ...
					    System.out.println(id);
					     DBhelperQ db2=new DBhelperQ();
					    ArrayList<titleinfo>arr1=db2.query_titletid(id);
					    for(int i=0;i<arr1.size();i++){
					    titleinfo ti=arr1.get(i);
					     %>
					<div class="box">
						<a href="#"><h4 class="vid-name">标题：<%=ti.getTitle() %></h4></a>
						<div class="wrap-vid">
							<p><h5>内容：</h5><%=ti.getTitlecontent() %></p>
