            ...
            <ul id="breadcrumb">
                ...
                <li class="pull-right">
                    <div class="input-group input-widget">
                        ...
                        <input style="border-radius:15px" type="text" placeholder="搜素..." class="form-control">
                    </div>
                </li>
            </ul>
...
<!--                        </div>-->
  <%
                  ...
                  ArrayList<saidinfo>arr=db.queryH_shuo(session.getAttribute("users").toString());
                  ...
                  saidinfo sa=arr.get(i);
                   %>
                        ...
                        <div class="blog-list-content">
                            ...
                            <hr>
                            <button class="btn btn-info pull-right"><a href="blog-detail1.jsp?id=<%=sa.getSaid() %>">Read More</a></button>
