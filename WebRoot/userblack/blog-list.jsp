...
<head>
    ...
    $(function(){
				$("#se").keyup(function(){
					$("#test").hide().filter(":contains('"人类"')").show();
				});
			});
    </script>
</head>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">个人应用</a>
                </li>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                ...
                <li class="pull-right">
                    <div class="input-group input-widget">
                        <input style="border-radius:15px" id="se" type="text" placeholder="搜索..." class="form-control">
                    </div>
                </li>
            </ul>
            ...
            <!--CONTENT-->
            <div id="test" class="row" style="margin-top:30px;padding:0 15px;">
                <!--  BLOG CONTENT -->
                <div class="col-sm-12">
                  <%
                  ...
                  ArrayList<titleinfo>arr=db.queryH_title(session.getAttribute("users").toString());
                   ...
                   %>
                    <div class="blog-list-nest">
                        ...
                        <div class="blog-list-content">
                            <h2><%=ti.getTitle() %></h2>
                            <p><%=ti.getTitlecontent() %></p>

                            <ul class="list-inline">
                                <li>
                                    <a href="#">
                                        <span class="entypo-network"></span>&nbsp;<%=ti.getCreate_time() %></a>
                                </li>
                                <li>
                                    <a href="#">
                            ...
                            <hr>
                            <button class="btn btn-info pull-right"><a href="blog-detail.jsp?id=<%=ti.getTitleid() %>">Read More</a> </button>
                    ...
                    <ul class="pager success">
                        ...
                        <li class="next disabled"><a href="#">更新 </a>
                        </a></li>
                    </ul>
