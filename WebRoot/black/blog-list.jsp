    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="social.jsp" title="Sample page 1">个人应用</a>
                </li>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
            ...
            <div id="test" class="row" style="margin-top:30px;padding:0 15px;">
                ...
                <div class="col-sm-12">
                  ...
                  ArrayList<titleinfo>arr=db.queryH_title(name);
                    ...
                    <div class="blog-list-nest">
                        ...
                        <div class="blog-list-content">
                            ...
                            <ul class="list-inline">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="entypo-chat"></span>&nbsp;2 评论</a>
                                </li>
                            </ul>
                            <hr>
                            <button class="btn btn-info pull-right"><a href="blog-detail.jsp?id=<%=ti.getTitleid() %>">更多</a> </button>
