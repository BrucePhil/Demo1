...
<html>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">说说列表</a>
                </li>
                <li class="pull-right">
  ...
  <%
                  ...
                  ArrayList<saidinfo>arr=db.queryH_shuo(name);
                  for(int i=0;i<arr.size();i++){
                  saidinfo sa=arr.get(i);
                   %>
...
<!--                        </div>-->
					...
					<img style="display:none; height: 150px;width: 150px;" src="../photo/<%=sa.getImage() %>">
					<%} else{%>
					<img style="height: 150px;width: 150px;" src="../photo/<%=sa.getImage() %>">
					...
					<%}%>
                            ...
                            <hr>
                            <button class="btn btn-info pull-right"><a href="blog-detail1.jsp?id=<%=sa.getSaid() %>">更多</a></button>
