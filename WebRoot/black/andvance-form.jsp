    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">文章类型发布</a>
                </li>
                <li class="pull-right">
                    ...
                    <div class="col-sm-12">
                        <div class="nest" id="headerClose">
                            ...
                            <div class="body-nest" id="header">
                                ...
                                <form class="form-horizontal" method="post" action="../servlet/add_typeservlet">
                                    <br/>
                                    <br/>
                                    <div class="form-group">
                                                    <label class="col-md-1 control-label">请输入文章类型:</label>
                                                    <div class="col-md-8">
                                                    
                                                        <input class="form-control" placeholder="请输入" name="type" type="text">
                                                    </div>
                                                </div>
                                                <br/>
                                                <br/>
