                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h6 id="myLargeModalLabel" class="modal-title">写邮件</h6>
                                    </div>
...
<!--            测试   -->
 					 ...
 					 <% DBhelper db=new DBhelper();
						...
						ArrayList<saidreviewinfo>arr=db.query_saidreviewinfo(session.getAttribute("user").toString());
						for(int i=0;i<arr.size();i++){
						saidreviewinfo re=arr.get(i);
					%>
                            ...
                            <div style="display: none" class="body-nest" id="<%=i %>">
                                <address>
                                    <strong>评论人：<%=re.getSrname() %></strong>
                                  <p>评论内容：<%=re.getSrcont() %></p>
                                </address>
                                <address>
                                    <strong>评论时间：<%=re.getSrtime() %></strong><hr/>
                                </address>
                                 
                                 <%  System.out.println("查看said"+re.getShuoid());
                                    	ArrayList<replyinfo>arr1=db.query_reply(re.getShuoid());
                                    
                                    	for(int j=0;j<arr1.size();j++)
                                    	{	replyinfo rep=arr1.get(j);
                                     
                                      if(re.getUserid()==rep.getReplyuserid()){
                                     %>
                                      <strong>回复人：<%=re.getSrname() %></strong><br/>
                                    <strong>回复时间：<%=rep.getReplytime() %></strong><br/>
                                     <strong>回复内容：<%=rep.getReplycont() %></strong><hr/>
                            ...
                            <div class="body-nest" style="display: none" id="c<%=i %>">
								...
								<div class="well" >
  						<form method="post" action="../servlet/addreply"> 
  						 <div class="form-group">
                              <input style="display: none" type="text" value="<%=re.getShuoid()%>" name="said">	
                               <input  style="display: none" type="text" value="<%=re.getUserid()%>" name="rename">	
