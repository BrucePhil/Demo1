    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="social.jsp" title="Sample page 1">主页</a>
                </li>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li><a href="#" title="Sample page 1">文章详情</a>
                </li>
                <li class="pull-right">
            ...
            <div class="row" style="margin-top:30px;padding:0 15px;">
                ...
                ArrayList<titleinfo>arr=db.query_Htitle(id);
                titleinfo ti=arr.get(0);
                 %>

                    <div class="blog-list-nest">
                    <form action="../servlet/del_titleservlet" method="post">
                        <div class="blog-list-content">
                            <h2><%=ti.getTitle() %></h2>
                            <p><%=ti.getTitlecontent() %></p>
                           <input style="display: none" type="text"  value="<%=ti.getTitleid()%>" name="id"></p>
                           <ul class="list-inline">
                            ...
                            <hr>
                            <input  class="btn btn-info pull-right" type="submit" value="删除"/>
