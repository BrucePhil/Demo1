...
<!--    -->
<script type="text/javascript" src="../black/js/jquery-1.4.1.js" ></script>
<script >
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <!-- END OF BREADCRUMB -->
                ...
                <div class="well">
<form  method="post" action="../servlet/addsaid" enctype="multipart/form-data" class="form-horizontal">
                        <h4>发布说说</h4>
                         <div class="btn-group pull-right">
                            <input type="button" id="btn" class="btn btn-info btn-lg dropdown-toggle" value="附加照片">
                        </div>
                        <div id="div">
                        <div style="padding:14px;" class="form-group">
                            <textarea  placeholder="请输入发布内容" rows="5" name="con" class="form-update"></textarea>
                        </div>
                      ...
                      <div class="btn-group pull-right">
                            <input type="submit" class="btn btn-info btn-lg dropdown-toggle" value="发布">
                        </div>
                     </div>
                     </div>
...
<!--                    -->
<form method="post" action="../servlet/addsaids" class="form-horizontal">
    <div id="div1">
                        <div style="padding:14px;" class="form-group">
                            <textarea placeholder="请输入发布内容" rows="5" name="con" class="form-update"></textarea>
                        </div>
